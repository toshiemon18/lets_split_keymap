 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  | Eisu |Lower |Space |Space |Raise | Kana | GUI  | Alt  | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LALT, KC_LGUI, KC_LANG2, LOWER,  KC_SPC,  KC_SPC,  RAISE,   KC_LANG1, KC_RGUI, KC_RALT, KC_RCTL  \
),
